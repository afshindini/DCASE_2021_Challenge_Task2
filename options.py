...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dim1', type=int, default=32, help='dimention 1 of the input')
        self.parser.add_argument('--dim2', type=int, default=32, help='dimention 2 of the input')
        ...
        self.parser.add_argument('--id', type=int, default='0', help='id of the machine')
        ##
        # Train
